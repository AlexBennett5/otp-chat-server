...
add_client_to_empty_server(ServerPid) ->
  ...
  ClientPid = self(),
  chat_genserv:add_client("Test One", 100, ClientPid),
  unmock_gen_tcp(),
  CurrentState = sys:get_state(ServerPid),
...
add_client_to_server_with_one(ServerPid) ->
  mock_gen_tcp_return_one(),
  ClientPidOne = self(),
  chat_genserv:add_client("Test One", 100, ClientPidOne),
  ClientPidTwo = self(),
  chat_genserv:add_client("Test Two", 101, ClientPidTwo),
  unmock_gen_tcp(),
  CurrentState = sys:get_state(ServerPid),
...
add_client_to_server_with_multiple(ServerPid) ->
  ...
  chat_genserv:add_client("Test Two", 101, ClientPidTwo),
  ClientPidThree = self(),
  chat_genserv:add_client("Test Three", 102, ClientPidThree),
  unmock_gen_tcp(),
  CurrentState = sys:get_state(ServerPid),
